...
class fully_connected_layers:
    ...
    def fit(self, input, expected_output):
        ...
        for i in range(0,size):
            ...
            binar = np.ones((hidden_layer_size,1))
            binar[:int(hidden_layer_size/2)] = 0
            ...
            print(layer_hidden_1_weight_delta.shape,binar.shape)
            layer_hidden_1_weight_delta=layer_hidden_1_weight_delta*binar
